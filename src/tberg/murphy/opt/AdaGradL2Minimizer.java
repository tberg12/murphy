...
public class AdaGradL2Minimizer implements OnlineMinimizer {
	...
	public static void main(String[] args) {
		...
		final double regConstant = 100.0;
		...
		{
			OnlineMinimizer minimizer = new AdaGradL2Minimizer(1e-2, 1e-4, regConstant, 50000);
			minimizer.minimize(functions, a.onesDouble(10), true, null);
		}
		
		{
			Minimizer minimizer = new LBFGSMinimizer(1e-10, 1000);
