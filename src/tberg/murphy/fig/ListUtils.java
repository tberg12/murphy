...
public class ListUtils
{
  ...
  public static int[] toArray(List<Integer> list) {
	...
	public static int[][] to2DIntArray(List<int[]> list) {
	...
	public static int[] sortedIndices(double[] list, boolean reverse) {
		...
		Collections.sort(pairList, reverse ? new Pair.ReverseFirstComparator<Double, Integer>() : new Pair.FirstComparator<Double, Integer>());
		// Extract the indices
	...
	public static int[] sortedIndices(int[] list, boolean reverse) {
		...
		Collections.sort(pairList, reverse ? new Pair.ReverseFirstComparator<Integer, Integer>() : new Pair.FirstComparator<Integer, Integer>());
		// Extract the indices
		int[] indices = new int[n];
		for (int i = 0; i < n; i++)
			indices[i] = pairList.get(i).getSecond();
